...
final class ReservationAlreadyDelivered extends Exception implements DomainExceptionInterface
{
    ...
    {
        parent::__construct(
            sprintf('Reservation with ID %s was already delivered.', $reservationId->toString()),
